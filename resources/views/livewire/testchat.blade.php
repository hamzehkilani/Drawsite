...
<div>
    <style>
        ...
        .d-flex.bd-highlight.align-items-center {
            ...
            <div class="col-md-4 col-xl-3 chat">
                <div class="card mb-sm-3 mb-md-0 contacts_card">
                    ...
                    <div class="card-body contacts_body">
                        @foreach ($friends as $frind)
                        @php
                        if ($frind->user_id == auth()->user()->id) {
                          $frind_id = $frind->friend_id;
                      } else {
                          $frind_id = $frind->user_id;
                      }
                      @endphp
                            <ul class="contacts" wire:click="showmassages({{$frind_id}})">
                                <li class="active">
                                    <div class="d-flex bd-highlight">
                                        ...
                                        <div class="user_info">
                                            @php
                                                ...
                                                $user_info = \App\Models\User::where('id', $frind_id)->first();
                                            @endphp
                    ...
                    <div class="card-footer">
                        <div class="input-group">
                            ...
                            <textarea name="" class="form-control type_msg" placeholder="Type your message..."
                                style="height: 14px !important;"></textarea>
                            <div class="input-group-append">
